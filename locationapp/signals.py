...
post_save.connect(receiver=CountryModelSignalReciever.country_created,
                  sender=CountryModelSignalReciever.model)
post_save.connect(receiver=CountryModelSignalReciever.country_updated,
                  sender=CountryModelSignalReciever.model)
post_delete.connect(receiver=CountryModelSignalReciever.country_deleted,
                    sender=CountryModelSignalReciever.model)
...
class LocationModelSignalReciever:
    ...
    def location_created(cls, sender, instance, created, **kwargs):
        ...
        if created:
            logger.info(
                f"Location '{instance.city_town}, {instance.country.name}' created.")
    ...
    def location_updated(cls, sender, instance, created, **kwargs):
        ...
        if not created:
            logger.info(
                f"Location '{instance.city_town}, {instance.country.name}' updated.")
    ...
    def location_deleted(cls, sender, instance, **kwargs):
        ...
        """
        logger.info(
            f"Location '{instance.city_town}, {instance.country.name}' deleted.")


post_save.connect(receiver=LocationModelSignalReciever.location_created,
                  sender=LocationModelSignalReciever.model)
post_save.connect(receiver=LocationModelSignalReciever.location_updated,
                  sender=LocationModelSignalReciever.model)
post_delete.connect(receiver=LocationModelSignalReciever.location_deleted,
                    sender=LocationModelSignalReciever.model)
